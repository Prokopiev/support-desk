...
/* General settings */
$hesk_settings['site_title']='Техническая поддержка';
...
$hesk_settings['hesk_title']='Техническая поддержка';
...
'custom1'=>array('use'=>1,'place'=>0,'type'=>'text','req'=>0,'name'=>'Телефон','maxlen'=>255,'value'=>''),
