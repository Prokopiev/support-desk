...
$hesklang['date']='Дата';
$hesklang['email']='Ваш e-mail';
$hesklang['ip']='IP';
$hesklang['message']='Сообщение';
$hesklang['add_reply']='Добавить коментарий';
...
$hesklang['submit_reply']='сохранить комментарий';
...
$hesklang['use_form_below']='Заполните форму запросу. Обязательные для заполнения поля отмечены';
...
$hesklang['ticket_submitted_success']='Ваш запрос был успешно отправлен. Номер вашего запроса';
...
$hesklang['attachments']='Присоединить файл';
