...
<table cellspacing="0" cellpadding="0" bgcolor="#ffca00" align="center" style="margin-top: 10px;">
	<tbody><tr>
		...
		<td style="background: url(&quot;http://img.66.ru/dez/reg2/bb.gif&quot;) repeat-x scroll 0% 0% transparent;"><input type="submit" style="width: 167px; height: 32px; color: rgb(87, 66, 0); padding-bottom: 5px; font-size: 14px; font-weight: bold;" value="Отправить заявку"></td>
